...
import com.jhotel.hotel.CheckIn;
import com.jhotel.hotel.Quarto;
import com.jhotel.pessoa.PessoaFisica;

public class JCheckIn implements JTela {
   ...
   public JCheckIn(JHotel owner, Quarto quarto) throws ParseException {
      this.owner = owner;
      this.quarto = quarto;
      initialize();
   }
   ...
   private void initialize() throws ParseException {
      ...
      JLabel lblHspedesDoQuarto = new JLabel("HÓSPEDES DO QUARTO");
      ...
      table_1 = Grade.cria("Nome", "Documento", "Data Nascimento");
      ...
      btnConfirmar.addActionListener(new ActionListener() {
         public void actionPerformed(ActionEvent arg0) {
            if (!Mensagem.confirma("Deseja confirmar o CheckIn")) {
               return;
            }

            try {
               CheckIn.criarHospedagem(quarto, txtNome.getText(), txtCPF.getText(), txtRG.getText(),
                     txtEndereco.getText(), txt_telefone.getText(), txtDiaria.getText(), txtEntrada.getText(), "",
                     txtSaida.getText(), "", getDependentes());
               Mensagem.atencao("CheckIn efetuado com sucesso");
               owner.atualizaGrade();
               jTela.dispose();
            } catch (Exception ex) {
         ...
         private PessoaFisica getDependentes() {
            return null;
         }
      });
      btnConfirmar.setBounds(350, 411, 160, 23);
